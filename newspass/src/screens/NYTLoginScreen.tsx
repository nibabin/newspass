...
export default function NYTLoginScreen({article} : {article: Article}) {
    ...
    return (
        <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
            {!payWallPass && <div className="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            {!payWallPass && <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
