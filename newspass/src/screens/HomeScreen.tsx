...
export default function HomeScreen() {
    ...
    return (
        <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md flex flex-col space-y-3" onClick={() => navigate('/nytLogin/article1')}>
                <div className=' bg-green-300 w-full p-2'>
                    <div className='w-full h-full  flex-col'>
                        <div>
                            <img src="https://static01.nyt.com/images/2023/01/27/multimedia/27dc-pce-jqwk/27dc-pce-jqwk-jumbo.jpg?quality=75&auto=webp"/>
                        </div>
                        <div>
                            New York Times
                        </div>
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md flex flex-col space-y-3" onClick={() => navigate('/nytLogin/article2')}>
                <div className=' bg-green-300 w-full p-2'>
                    <div className='w-full h-full  flex-col'>
                        <div>
                            <img src="https://static01.nyt.com/images/2023/01/28/lens/28DC-CHINACHIPS-01/28DC-CHINACHIPS-01-jumbo.jpg?quality=75&auto=webp"/>
                        </div>
                        <div>
                            New York Times
                        </div>
            ...
            <div className="w-full h-12 bg-gray-300 fixed left-0 bottom-0 flex justify-around items-center text-white text-2xl">
                <div className="ml-1 w-15 h-15 round bg-gray-100 font-black">
